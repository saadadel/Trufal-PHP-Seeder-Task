...
class MovieServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->loadMigrationsFrom(module_path('Movie', 'Database/Migrations'));
    }
    ...
    {
        $this->publishes([
            module_path('Movie', 'Config/config.php') => config_path('movie.php'),
        ], 'config');
        $this->mergeConfigFrom(
            module_path('Movie', 'Config/config.php'), 'movie'
        );
    }
    ...
    public function registerViews()
    {
        ...
        $sourcePath = module_path('Movie', 'Resources/views');
    ...
    public function registerFactories()
    {
        if (! app()->environment('production') && $this->app->runningInConsole()) {
            app(Factory::class)->load(module_path('Movie', 'Database/factories'));
        }
    }
